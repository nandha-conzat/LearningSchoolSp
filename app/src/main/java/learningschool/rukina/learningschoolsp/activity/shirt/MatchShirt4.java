 ...
 */
public class MatchShirt4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shirt, drop_shut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_4_hi);
        mp = new MediaPlayer();
        playTitle();
        ...
        drop_shut = (RelativeLayout) findViewById(R.id.fixed_shut_word_card_layout);
        dispaly = (TextView)findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v4);
        back = (ImageView) findViewById(R.id.imageback_pa4_v4);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v4);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirt4.this);
...
//
        ...
        drop_shut.setOnDragListener(new View.OnDragListener() {
