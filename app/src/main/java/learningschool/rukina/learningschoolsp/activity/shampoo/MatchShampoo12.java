 ...
 */
public class MatchShampoo12 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView shampoo, utens, blue, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_12_hi);
        mp = new MediaPlayer();
        playTitle();

        shampoo = (TextView) findViewById(R.id.txt_shampoo);
        utens = (TextView) findViewById(R.id.txt_uten);
        blue = (TextView) findViewById(R.id.txt_blue);
        ...
        utens.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchShampoo12.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s117_hi);// create's
