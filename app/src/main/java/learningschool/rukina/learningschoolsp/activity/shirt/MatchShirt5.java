 ...
 */
public class MatchShirt5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_5_hi);
        mp = new MediaPlayer();
        playTitle();

        next = (ImageView) findViewById(R.id.imageNext_pa4_v5);
        back = (ImageView) findViewById(R.id.imageback_pa4_v5);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v5);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s60_hi);// create's
