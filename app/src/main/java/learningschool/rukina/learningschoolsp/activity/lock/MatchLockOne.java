 ...
 */
public class MatchLockOne extends AppCompatActivity {
    private MediaPlayer mp;
    LinearLayout lock, key;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_lock_one_hi);
        mp = new MediaPlayer();
        lock = (LinearLayout) findViewById(R.id.pa1_lock1);
        key = (LinearLayout) findViewById(R.id.pa1_lock3);
        back = (ImageView) findViewById(R.id.imageback_lock_v1);
        home = (ImageView) findViewById(R.id.imagehome_lock_v1);
        next = (ImageView) findViewById(R.id.imageNext_lock_v1);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_lock);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.lock_v1);// create's
