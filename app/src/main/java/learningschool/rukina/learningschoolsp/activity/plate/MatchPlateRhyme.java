 ...
 */
public class MatchPlateRhyme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_rhyme_hi);
        mp = new MediaPlayer();
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.rhyme);// create's
