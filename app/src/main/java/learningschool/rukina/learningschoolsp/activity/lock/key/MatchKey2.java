 ...
 */
public class MatchKey2 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_key, drop_fish;
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey2.this);
...
//
        ...
        drop_fish.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s158_hi);// create's
