 ...
 */
public class MatchTray11 extends AppCompatActivity {
    ImageView next, door, back, home;
    RelativeLayout find_tray, find_class;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_11_hi);
        mp = new MediaPlayer();
        playTitle();

        find_tray = (RelativeLayout) findViewById(R.id.find_tray_layout);
        find_class = (RelativeLayout) findViewById(R.id.find_class_layout);
        ...
        find_tray.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchTray11.this);
        ...
        find_class.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s134_hi);// create's
