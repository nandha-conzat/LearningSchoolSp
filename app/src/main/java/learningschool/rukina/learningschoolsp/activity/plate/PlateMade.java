 ...
 */
public class PlateMade extends AppCompatActivity {
    ImageView next, paper, plastic, steel,back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.plate_made_hi);
        mp = new MediaPlayer();
        playTitle();

        paper = (ImageView) findViewById(R.id.drag_plate);
        plastic = (ImageView) findViewById(R.id.drag_plate1);
        steel = (ImageView) findViewById(R.id.drag_plate2);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v16);
        back = (ImageView) findViewById(R.id.imageback_pa1_v16);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v16);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v16);// create's
    ...
    public void paper() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v16_1);// create's
        mp.start(); // starting mediaplayer
    }
    ...
    public void plastic() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v16_2);// create's
        mp.start(); // starting mediaplayer
    }
    ...
    public void steel() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v16_3);// create's
        mp.start(); // starting mediaplayer
    }
