 ...
 */
public class MatchKnife2 extends AppCompatActivity {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnife2.this);
