 ...
 */
public class MatchShampoo2 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shampoo, drop_juice;
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass_hi(MatchShampoo2.this);
...
//
        ...
        drop_juice.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s107_hi);// create's
