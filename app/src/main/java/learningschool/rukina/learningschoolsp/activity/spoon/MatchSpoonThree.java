 ...
 */
public class MatchSpoonThree extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_spoon, drop_sponge;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_three_hi);
        ...
        drop_sponge = (RelativeLayout) findViewById(R.id.fixed_sponge_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v3);
        back = (ImageView) findViewById(R.id.imageback_pa2_v3);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v3);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonThree.this);
...
//
        ...
        drop_sponge.setOnDragListener(new View.OnDragListener() {
