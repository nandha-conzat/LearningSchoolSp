 ...
 */
public class MatchShampoo5 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_bottle, drop_shalimar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_5_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_bottle_word_card);
        drop_bottle = (RelativeLayout) findViewById(R.id.fixed_bottle_word_card_layout);
        drop_shalimar = (RelativeLayout) findViewById(R.id.fixed_Shalimar_word_card_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShampoo5.this);
...
//
        ...
        drop_shalimar.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s110_hi);// create's
