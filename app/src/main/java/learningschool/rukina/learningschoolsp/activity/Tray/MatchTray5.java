 ...
 */
public class MatchTray5 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tray, drop_treat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_5_hi);
        mp = new MediaPlayer();
        playTitle();
        ...
        drop_treat = (RelativeLayout) findViewById(R.id.fixed_treat_word_card_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray5.this);
...
//
        ...
        drop_treat.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s128_hi);// create's
