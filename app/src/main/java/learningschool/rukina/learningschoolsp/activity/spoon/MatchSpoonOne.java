 ...
 */
public class MatchSpoonOne extends AppCompatActivity {

    private MediaPlayer mp;
    LinearLayout ThisSpoon, CookSpoon, EatSpoon, FedSpoon;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_spoon_one_hi);
        mp = new MediaPlayer();
        ThisSpoon = (LinearLayout) findViewById(R.id.pa1_thisspoon);
        CookSpoon = (LinearLayout) findViewById(R.id.pa1_cookspoon);
        EatSpoon = (LinearLayout) findViewById(R.id.pa1_eatspoon);
        FedSpoon = (LinearLayout) findViewById(R.id.pa1_fedspoon);
        back = (ImageView) findViewById(R.id.imageback_spoon_v1);
        home = (ImageView) findViewById(R.id.imagehome_spoon_v1);
        next = (ImageView) findViewById(R.id.imageNext_spoon_v1);

        playTitle();

        ThisSpoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.spoon_v1_1);// create's
                mp.start(); // starting mediaplayer
            }
        });

        CookSpoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.spoon_v1_2);// create's
                mp.start(); // starting mediaplayer
            }
        });

        EatSpoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.spoon_v1_3);// create's
                mp.start(); // starting mediaplayer
            }
        });

        FedSpoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.spoon_v1_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_spoon);
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.spoon_v1);// create's
        mp.start(); // starting mediaplayer
    }
