 ...
 */
public class MatchShirt12 extends AppCompatActivity {
    ImageView drag, next, back, home, dirt, shirt, fix_shirt, spot, shrine;
    private MediaPlayer mp;
    TextView photo, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_12_hi);
        mp = new MediaPlayer();
        playTitle();

        dirt = (ImageView) findViewById(R.id.dirt_image12);
        shirt = (ImageView) findViewById(R.id.shirt_image12);
        fix_shirt = (ImageView) findViewById(R.id.fix_shirt_image12);
        spot = (ImageView) findViewById(R.id.spot_image12_fixed);
        shrine = (ImageView) findViewById(R.id.shrine_image12_fix);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v12);
        back = (ImageView) findViewById(R.id.imageback_pa4_v12);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v12);
...
//                dispaly.setTextColor(Color.GREEN);
                cdd = new CustomDialogClass_hi(MatchShirt12.this);
        ...
        fix_shirt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s67_hi);// create's
