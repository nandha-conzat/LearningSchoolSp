 ...
 */
public class MatchShampoo8 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shampoo, drop_shoulder, drop_sharper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shampoo_frame);
        drop_shampoo = (RelativeLayout) findViewById(R.id.fixed_shampoo_layout);
        drop_shoulder = (RelativeLayout) findViewById(R.id.fixed_shoulder_frame);
        drop_sharper = (RelativeLayout) findViewById(R.id.fixed_sharper_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShampoo8.this);
        ...
        drop_shoulder.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_sharper.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s113_hi);// create's
