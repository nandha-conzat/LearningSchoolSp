 ...
 */
public class MatchKnifeOne extends AppCompatActivity {
    private MediaPlayer mp;
    LinearLayout knife1, knife2, knife3, knife4;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_knife_one_hi);
        mp = new MediaPlayer();
        knife1 = (LinearLayout) findViewById(R.id.pa1_thisknife);
        knife2 = (LinearLayout) findViewById(R.id.pa1_knife2);
        knife3 = (LinearLayout) findViewById(R.id.pa1_knife3);
        knife4 = (LinearLayout) findViewById(R.id.pa1_knife4);
        back = (ImageView) findViewById(R.id.imageback_knife_v1);
        home = (ImageView) findViewById(R.id.imagehome_kinfe_v1);
        next = (ImageView) findViewById(R.id.imageNext_knife_v1);
        playTitle();

        knife4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.knife_v1);// create's
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_knife);
