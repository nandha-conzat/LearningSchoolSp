 ...
 */
public class MatchBottle3 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_bottle, drop_boat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_3_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_bottle);
        drop_bottle = (RelativeLayout) findViewById(R.id.fixed_bottle_layout);
        drop_boat = (RelativeLayout) findViewById(R.id.fixed_boat_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        back = (ImageView) findViewById(R.id.imageback_bottle_v3);
        home = (ImageView) findViewById(R.id.imagehome_bottle_v3);
        next = (ImageView) findViewById(R.id.imageNext_bottle_v3);
            ...
            public boolean onDrag(View v, DragEvent event) {
                ...
                switch (action) {
                    ...
                    case DragEvent.ACTION_DROP: {
                        ...
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle3.this);
...
//
        ...
        drop_boat.setOnDragListener(new View.OnDragListener() {
