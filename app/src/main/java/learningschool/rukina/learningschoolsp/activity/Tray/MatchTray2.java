 ...
 */
public class MatchTray2 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tray, drop_clock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_2_hi);

        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_tary);
        drop_tray = (RelativeLayout) findViewById(R.id.fixed_tray_layout);
        drop_clock = (RelativeLayout) findViewById(R.id.fixed_clock_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray2.this);
...
//
        ...
        drop_clock.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s125_hi);// create's
