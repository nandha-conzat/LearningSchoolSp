 ...
 */
public class MatchShampoo4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shampoo, drop_classic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_4_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shampoo);
        drop_shampoo = (RelativeLayout) findViewById(R.id.fixed_shampoo_layout);
        drop_classic = (RelativeLayout) findViewById(R.id.fixed_classic_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass_hi(MatchShampoo4.this);
...
//
        ...
        drop_classic.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s109_hi);// create's
