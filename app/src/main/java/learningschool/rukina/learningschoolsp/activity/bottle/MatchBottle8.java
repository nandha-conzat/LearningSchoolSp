 ...
 */
public class MatchBottle8 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tattle, drop_mottle, drop_bottle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_bottle_frame);
        drop_tattle = (RelativeLayout) findViewById(R.id.fixed_tattle_layout);
        drop_mottle = (RelativeLayout) findViewById(R.id.fixed_mottle_frame);
            ...
            public boolean onDrag(View v, DragEvent event) {
                ...
                switch (action) {
                    ...
                    case DragEvent.ACTION_DROP: {
                        ...
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle8.this);
        ...
        drop_mottle.setOnDragListener(new View.OnDragListener() {
        ...
        drop_tattle.setOnDragListener(new View.OnDragListener() {
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s96_hi);// create's
