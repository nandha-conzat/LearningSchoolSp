 ...
 */
public class MatchSoap3 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_soap, drop_lather;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_3_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_soap);
        drop_soap = (RelativeLayout) findViewById(R.id.fixed_soap_layout);
        drop_lather = (RelativeLayout) findViewById(R.id.fixed_lather_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v3);
        back = (ImageView) findViewById(R.id.imageback_pa3_v3);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v3);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSoap3.this);
...
//
        ...
        drop_lather.setOnDragListener(new View.OnDragListener() {
