 ...
 */
public class MatchShirt15 extends AppCompatActivity {
    ImageView drag, next, back, home, frock, shirt, skirt, helmet, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_15_hi);
        mp = new MediaPlayer();
        playTitle();

        frock = (ImageView) findViewById(R.id.drag_frock_frame);
        shirt = (ImageView) findViewById(R.id.collar_shirt);
        skirt = (ImageView) findViewById(R.id.drag_shirt_frame_fixed);
        helmet = (ImageView) findViewById(R.id.fixed_helmet);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchShirt15.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                empty.setImageResource(R.drawable.shirt_s70_5);
                try {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s70_hi);// create's
