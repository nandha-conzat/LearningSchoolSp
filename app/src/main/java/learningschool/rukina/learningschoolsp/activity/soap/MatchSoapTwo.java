 ...
 */
public class MatchSoapTwo extends AppCompatActivity {

    ImageView drag, back, home, next;
    RelativeLayout drop_soap, drop_dish;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_two_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_soap);
        drop_soap = (RelativeLayout) findViewById(R.id.fixed_soap_layout);
        drop_dish = (RelativeLayout) findViewById(R.id.fixed_dish_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        back = (ImageView) findViewById(R.id.imageback_soap_v2);
        home = (ImageView) findViewById(R.id.imagehome_soap_v2);
        next = (ImageView) findViewById(R.id.imageNext_soap_v2);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSoapTwo.this);
...
//
        ...
        drop_dish.setOnDragListener(new View.OnDragListener() {
