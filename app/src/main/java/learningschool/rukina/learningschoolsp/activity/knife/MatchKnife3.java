 ...
 */
public class MatchKnife3 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_knife, drop_chilly;
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnife3.this);
...
//
        ...
        drop_chilly.setOnDragListener(new View.OnDragListener() {
