 ...
 */
public class MatchSoapOne extends AppCompatActivity {
    private MediaPlayer mp;
    LinearLayout ThisSoap, BathSoap, WashSoap, CleanSoap;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_soap_one_hi);
        mp = new MediaPlayer();
        ThisSoap = (LinearLayout) findViewById(R.id.pa1_thissoap);
        BathSoap = (LinearLayout) findViewById(R.id.pa1_bathsoap);
        WashSoap = (LinearLayout) findViewById(R.id.pa1_washsoap);
        CleanSoap = (LinearLayout) findViewById(R.id.pa1_cleansoap);
        back = (ImageView) findViewById(R.id.imageback_soap_v1);
        home = (ImageView) findViewById(R.id.imagehome_soap_v1);
        next = (ImageView) findViewById(R.id.imageNext_soap_v1);

        playTitle();

        ThisSoap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.soap_v1_1);// create's
                mp.start(); // starting mediaplayer
            }
        });

        BathSoap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.soap_v1_2);// create's
                mp.start(); // starting mediaplayer
            }
        });

        WashSoap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.soap_v1_3);// create's
                mp.start(); // starting mediaplayer
            }
        });

        CleanSoap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.soap_v1_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_soap);
    ...
    public void playTitle() {
        ...
        mp.reset();// stops any current playing song
        mp = MediaPlayer.create(getApplicationContext(), R.raw.soap_v1);// create's
        mp.start(); // starting mediaplayer
    }
