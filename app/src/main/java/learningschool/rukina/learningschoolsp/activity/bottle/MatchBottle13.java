 ...
 */
public class MatchBottle13 extends AppCompatActivity {
    ImageView next, bottle, bond, bowl, bound, bitten, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_13_hi);
        mp = new MediaPlayer();
        playTitle();

        bottle = (ImageView) findViewById(R.id.bottle_image13);
        bond = (ImageView) findViewById(R.id.bond_image13);
        bowl = (ImageView) findViewById(R.id.bowl_image13);
        bound = (ImageView) findViewById(R.id.bound_image13);
        bitten = (ImageView) findViewById(R.id.bitten_image13);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchBottle13.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s101_hi);// create's
