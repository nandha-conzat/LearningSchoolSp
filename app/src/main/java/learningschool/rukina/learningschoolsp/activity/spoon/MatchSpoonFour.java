 ...
 */
public class MatchSpoonFour extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_spoon, drop_sprout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_four_hi);
        ...
        drop_sprout = (RelativeLayout) findViewById(R.id.fixed_sprout_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v4);
        back = (ImageView) findViewById(R.id.imageback_pa2_v4);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v4);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonFour.this);
...
//
        ...
        drop_sprout.setOnDragListener(new View.OnDragListener() {
