 ...
 */
public class MatchSpoonEight extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_spoil, drop_school, drop_spoon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_eight_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_spoon_frame);
        drop_spoil = (RelativeLayout) findViewById(R.id.fixed_spoil_layout);
        drop_school = (RelativeLayout) findViewById(R.id.fixed_school_frame);
        drop_spoon = (RelativeLayout) findViewById(R.id.fixed_spoon_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v8);
        back = (ImageView) findViewById(R.id.imageback_pa2_v8);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v8);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonEight.this);
        ...
        drop_spoil.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_school.setOnDragListener(new View.OnDragListener() {
