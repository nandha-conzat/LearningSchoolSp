 ...
 */
public class MatchSoap6 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_towel, drop_soap, drop_pants;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_6_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_soap_frame);
        drop_towel = (RelativeLayout) findViewById(R.id.fixed_towel_frame);
        drop_soap = (RelativeLayout) findViewById(R.id.fixed_soap_layout);
        drop_pants = (RelativeLayout) findViewById(R.id.fixed_pants_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v6);
        back = (ImageView) findViewById(R.id.imageback_pa3_v6);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v6);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSoap6.this);
        ...
        drop_towel.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_pants.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s45n46);// create's
