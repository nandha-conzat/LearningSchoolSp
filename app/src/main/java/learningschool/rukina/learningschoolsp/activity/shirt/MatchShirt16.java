 ...
 */
public class MatchShirt16 extends AppCompatActivity {
    TextView option_a1, option_a2, option_a3, option_a4, option_a5, option_a6, option_a7,
            ...
            choice_e1, choice_e2, choice_e3, choice_e4, choice_e5, choice_e6, choice_e7,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_16_hi);
        mp = new MediaPlayer();
        ...
        choice_e7 = (TextView) findViewById(R.id.option_e7);
        ...
        choice_e7.setOnTouchListener(new ChoiceTouchListener());
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String a2 = option_c3.getText().toString().trim();
                        String b2 = option_c4.getText().toString().trim();
                        String c2 = option_c5.getText().toString().trim();
                        String d2 = option_c6.getText().toString().trim();
                        String e2 = option_c7.getText().toString().trim();
                        ...
                        userEntered = "" + a + b + c + d + a1 + b1 + c1 + d1 + e1 + a2 + b2 + c2 + d2 + e2 + a3 + b3 + c3 + d3 + e3;
                        if (userEntered.equals("so.a.p.s.po.o.n.p.l.at.es.hi.rt.")) {
                            playPerfect();
                            cdd = new CustomDialogClass_hi(MatchShirt16.this);
