 ...
 */
public class MatchShirt10 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView shirt, photo, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_10_hi);
        mp = new MediaPlayer();
        playTitle();

        shirt = (TextView) findViewById(R.id.txt_shirt);
        photo = (TextView) findViewById(R.id.txt_photo);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchShirt10.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s65_hi);// create's
