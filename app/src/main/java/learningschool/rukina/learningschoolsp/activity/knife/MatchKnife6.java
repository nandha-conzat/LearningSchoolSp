 ...
 */
public class MatchKnife6 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_curtain, drop_cooker, drop_knife;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_6_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_knife_frame);
        drop_curtain = (RelativeLayout) findViewById(R.id.fixed_curtain_layout);
        drop_cooker = (RelativeLayout) findViewById(R.id.fixed_cooker_frame);
        drop_knife = (RelativeLayout) findViewById(R.id.fixed_knife_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnife6.this);
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_cooker.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s79_hi);// create's
