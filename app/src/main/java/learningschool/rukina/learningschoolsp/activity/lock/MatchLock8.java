 ...
 */
public class MatchLock8 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_lock, drop_tick, drop_kite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_lock_frame);
        drop_lock = (RelativeLayout) findViewById(R.id.fixed_lock_layout);
        drop_tick = (RelativeLayout) findViewById(R.id.fixed_tick_frame);
        drop_kite = (RelativeLayout) findViewById(R.id.fixed_kite_layout);
        ...
        drop_lock.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass_hi(MatchLock8.this);
        ...
        drop_kite.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_tick.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s148_hi);// create's
