 ...
 */
public class MatchBottle15 extends AppCompatActivity {
    ImageView drag, next, back, home, boat, bun, bottle, box, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_15_hi);
        mp = new MediaPlayer();
        playTitle();

        boat = (ImageView) findViewById(R.id.drag_boat_frame);
        bun = (ImageView) findViewById(R.id.fixed_bun);
        bottle = (ImageView) findViewById(R.id.drag_bottle_frame_fixed);
        box = (ImageView) findViewById(R.id.collar_box);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchBottle15.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                empty.setImageResource(R.drawable.bottle_s103_3);
                try {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s103_hi);// create's
