 ...
 */
public class MatchKey3 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_key, drop_kite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_3_hi);
        mp = new MediaPlayer();
        playTitle();
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey3.this);
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s159_hi);// create's
