 ...
 */
public class MatchShampooOne extends AppCompatActivity {
    private MediaPlayer mp;
    LinearLayout shampoo1, shampoo2;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_shampoo_one_hi);
        mp = new MediaPlayer();
        shampoo1 = (LinearLayout) findViewById(R.id.pa1_shampoo1);
        shampoo2 = (LinearLayout) findViewById(R.id.pa1_shampoo2);

        back = (ImageView) findViewById(R.id.imageback_shampoo_v1);
        home = (ImageView) findViewById(R.id.imagehome_shampoo_v1);
        next = (ImageView) findViewById(R.id.imageNext_shampoo_v1);
        playTitle();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MatchShampooOne.this,
                        DashBoard_hi.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_shampoo);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.shampoo_v1);// create's
