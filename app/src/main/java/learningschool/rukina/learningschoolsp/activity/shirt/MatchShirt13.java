 ...
 */
public class MatchShirt13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_13_hi);
        mp = new MediaPlayer();
        playTitle();
        ...
        next = (ImageView) findViewById(R.id.imageNext_pa4_v13);
        back = (ImageView) findViewById(R.id.imageback_pa4_v13);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v13);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s68_hi);// create's
