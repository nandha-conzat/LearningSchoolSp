 ...
 */
public class MatchLock7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_lock, drop_tree, drop_duck;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_lock_frame);
        drop_lock = (RelativeLayout) findViewById(R.id.fixed_lock_layout);
        drop_tree = (RelativeLayout) findViewById(R.id.fixed_tree_layout);
        drop_duck = (RelativeLayout) findViewById(R.id.fixed_duck_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchLock7.this);
        ...
        drop_tree.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_duck.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s147_hi);// create's
