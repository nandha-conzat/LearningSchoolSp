 ...
 */
public class
MatchSpoonFive extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_spoon, drop_bucket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_five_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_spoon_word_card);
        drop_spoon = (RelativeLayout) findViewById(R.id.fixed_spoon_word_card_layout);
        drop_bucket = (RelativeLayout) findViewById(R.id.fixed_bucket_word_card_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v5);
        back = (ImageView) findViewById(R.id.imageback_pa2_v5);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v5);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonFive.this);
...
//
        ...
        drop_bucket.setOnDragListener(new View.OnDragListener() {
