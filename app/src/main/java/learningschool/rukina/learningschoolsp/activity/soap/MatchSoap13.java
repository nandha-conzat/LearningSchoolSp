 ...
 */
public class MatchSoap13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_13_hi);
        mp = new MediaPlayer();
        playTitle();
        next = (ImageView) findViewById(R.id.imageNext_pa3_v13);
        back = (ImageView) findViewById(R.id.imageback_pa3_v13);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v13);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s52);// create's
