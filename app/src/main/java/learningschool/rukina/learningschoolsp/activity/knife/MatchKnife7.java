 ...
 */
public class MatchKnife7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_know, drop_knight, drop_knife;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_knife_frame);
        drop_know = (RelativeLayout) findViewById(R.id.fixed_know_layout);
        drop_knight = (RelativeLayout) findViewById(R.id.fixed_knight_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnife7.this);
        ...
        drop_knight.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_know.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s80_hi);// create's
