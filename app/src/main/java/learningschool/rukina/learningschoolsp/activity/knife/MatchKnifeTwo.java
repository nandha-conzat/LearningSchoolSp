 ...
 */
public class MatchKnifeTwo extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_knife, drop_pumpkin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_two_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_knife);
        drop_knife = (RelativeLayout) findViewById(R.id.fixed_kinfe_layout);
        drop_pumpkin = (RelativeLayout) findViewById(R.id.fixed_pumpkin_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        back = (ImageView) findViewById(R.id.imageback_knife_v2);
        home = (ImageView) findViewById(R.id.imagehome_knife_v2);
        next = (ImageView) findViewById(R.id.imageNext_knife_v2);

        drop_knife.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnifeTwo.this);
...
//
        ...
        drop_pumpkin.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MatchKnifeTwo.this,
                        DashBoard_hi.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_plate:
                ...
                Toast.makeText(MatchKnifeTwo.this, "Plate", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Plate = new Intent(MatchKnifeTwo.this,
            ...
            case R.id.menu_spoon:
                Toast.makeText(MatchKnifeTwo.this, "Spoon", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Spoon = new Intent(MatchKnifeTwo.this,
                        MatchSpoonOne.class);
            ...
            case R.id.menu_soap:
                Toast.makeText(MatchKnifeTwo.this, "Soap", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Soap = new Intent(MatchKnifeTwo.this,
                        MatchSoapOne.class);
            ...
            case R.id.menu_shirt:
                Toast.makeText(MatchKnifeTwo.this, "Shirt", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Shirt = new Intent(MatchKnifeTwo.this,
                        MatchShirtOne.class);
            ...
            case R.id.menu_knife:
                Toast.makeText(MatchKnifeTwo.this, "Knife", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Knife = new Intent(MatchKnifeTwo.this,
                        MatchKnifeOne.class);
            ...
            case R.id.menu_bottle:
                Toast.makeText(MatchKnifeTwo.this, "Bottle", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Bottle = new Intent(MatchKnifeTwo.this,
                        MatchBottleOne.class);
                Bottle.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(Bottle);
                return true;
            case R.id.menu_shampoo:
                Toast.makeText(MatchKnifeTwo.this, "Shampoo", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Shampoo = new Intent(MatchKnifeTwo.this,
            ...
            case R.id.menu_tray:
                Toast.makeText(MatchKnifeTwo.this, "Tray", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Tray = new Intent(MatchKnifeTwo.this,
                        MatchTrayOne.class);
            ...
            case R.id.menu_lock:
                Toast.makeText(MatchKnifeTwo.this, "Lock", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Lock = new Intent(MatchKnifeTwo.this,
                        MatchLockOne.class);
