 ...
 */
public class MatchSpoonSixteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_sixteen_hi);
        mp = new MediaPlayer();
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String s = choice1.getText().toString().trim();
                        String p = choice2.getText().toString().trim();
                        String o = choice3.getText().toString().trim();
                        String o1 = choice4.getText().toString().trim();
                        String n = choice5.getText().toString().trim();

                        userEntered = "" + s + p + o + o1 + n;
                        if (userEntered.equals("s .p .o .o .n .")) {
                            playPerfect();
                            cdd = new CustomDialogClass_hi(MatchSpoonSixteen.this);
