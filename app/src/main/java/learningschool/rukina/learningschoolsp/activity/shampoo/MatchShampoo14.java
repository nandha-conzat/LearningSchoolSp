 ...
 */
public class MatchShampoo14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_14_hi);
        mp = new MediaPlayer();
        playTitle();
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s119_hi);// create's
