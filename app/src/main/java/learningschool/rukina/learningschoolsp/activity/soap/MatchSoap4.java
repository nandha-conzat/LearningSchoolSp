 ...
 */
public class MatchSoap4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_soap, drop_slop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_4_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_soap_word_card);
        drop_soap = (RelativeLayout) findViewById(R.id.fixed_soap_word_card_layout);
        drop_slop = (RelativeLayout) findViewById(R.id.fixed_slop_word_card_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSoap4.this);
...
//
        ...
        drop_slop.setOnDragListener(new View.OnDragListener() {
