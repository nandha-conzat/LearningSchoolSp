package learningschool.rukina.learningschoolsp.activity.bottle;
 ...
 */
public class MatchBottle9 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_little, drop_cattle, drop_kettle, drop_bottle, drop_rattle, drop_shuttle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_9_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_bottle_frame);
        drop_little = (RelativeLayout) findViewById(R.id.fixed_little_layout);
        drop_cattle = (RelativeLayout) findViewById(R.id.fixed_cattle_frame);
        drop_kettle = (RelativeLayout) findViewById(R.id.fixed_kettle_layout);
        drop_bottle = (RelativeLayout) findViewById(R.id.fixed_bottle_layout);
        drop_rattle = (RelativeLayout) findViewById(R.id.fixed_rattle_frame);
        drop_shuttle = (RelativeLayout) findViewById(R.id.fixed_shuttle_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v8);
        back = (ImageView) findViewById(R.id.imageback_pa1_v8);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v8);

        drop_bottle.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle9.this);
        ...
        drop_cattle.setOnDragListener(new View.OnDragListener() {
        ...
        drop_kettle.setOnDragListener(new View.OnDragListener() {
        ...
        drop_little.setOnDragListener(new View.OnDragListener() {
        ...
        drop_rattle.setOnDragListener(new View.OnDragListener() {
        ...
        drop_shuttle.setOnDragListener(new View.OnDragListener() {
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s97_hi);// create's
