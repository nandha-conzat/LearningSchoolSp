 ...
 */
public class MatchPlateNine extends AppCompatActivity {
    ImageView next, plate, plead, play, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_nine_hi);
        mp = new MediaPlayer();
        playTitle();

        play = (ImageView) findViewById(R.id.play_image);
        plate = (ImageView) findViewById(R.id.plate_image);
        plead = (ImageView) findViewById(R.id.plead_image);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v13);
        back = (ImageView) findViewById(R.id.imageback_pa1_v13);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v13);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchPlateNine.this);
        ...
        plead.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
