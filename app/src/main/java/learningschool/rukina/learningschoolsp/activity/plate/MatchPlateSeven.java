...
/**
 * Created by Nandha on 20-12-2015.
 */
public class MatchPlateSeven extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_pilot, drop_plot, drop_plate, drop_plain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_seven_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_plate);
        drop_pilot = (RelativeLayout) findViewById(R.id.fixed_pilot_layout);
        drop_plot = (RelativeLayout) findViewById(R.id.fixed_plot_layout);
        drop_plate = (RelativeLayout) findViewById(R.id.fixed_plate_layout);
        drop_plain = (RelativeLayout) findViewById(R.id.fixed_plain_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v10);
        back = (ImageView) findViewById(R.id.imageback_pa1_v10);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v10);
        ...
        drop_plate.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchPlateSeven.this);
        ...
        drop_plot.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_pilot.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_plain.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v8n9);// create's
