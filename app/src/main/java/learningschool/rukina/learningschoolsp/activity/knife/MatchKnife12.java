 ...
 */
public class MatchKnife12 extends AppCompatActivity {
    ImageView drag, next, back, home, knife, sniff, know, kiwi, hike;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_12_hi);
        mp = new MediaPlayer();
        playTitle();

        sniff = (ImageView) findViewById(R.id.sniff_image12);
        knife = (ImageView) findViewById(R.id.knife_image12_fixed);
        know = (ImageView) findViewById(R.id.fix_know_image12);
        kiwi = (ImageView) findViewById(R.id.kiwi_image12);
        hike = (ImageView) findViewById(R.id.hike_image12_fix);
...
//                dispaly.setTextColor(Color.RED);
        ...
        knife.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchKnife12.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s85_hi);// create's
