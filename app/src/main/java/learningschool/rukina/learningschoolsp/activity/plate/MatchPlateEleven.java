...
/**
 * Created by Nandha on 21-12-2015.
 */
public class MatchPlateEleven extends AppCompatActivity {
    ImageView next, plait, plod, plane, plate, play, plant, ply,back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_eleven_hi);
        mp = new MediaPlayer();
        playTitle();

        plait = (ImageView) findViewById(R.id.plait_image15);
        plod = (ImageView) findViewById(R.id.plod_image15);
        plane = (ImageView) findViewById(R.id.plane_image15);
        plate = (ImageView) findViewById(R.id.plate_image15);
        play = (ImageView) findViewById(R.id.play_image15);
        plant = (ImageView) findViewById(R.id.plant_image15);
        ply = (ImageView) findViewById(R.id.ply_image15);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v15);
        back = (ImageView) findViewById(R.id.imageback_pa1_v15);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v15);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);

        plait.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.RED);
        ...
        plod.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass_hi(MatchPlateEleven.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v13);// create's
