 ...
 */
public class MatchTray15 extends AppCompatActivity {
    ImageView drag, next, back, home, clay, tray, spray, trail, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_15_hi);
        mp = new MediaPlayer();
        playTitle();

        clay = (ImageView) findViewById(R.id.drag_clay_frame);
        tray = (ImageView) findViewById(R.id.fixed_tary);
        spray = (ImageView) findViewById(R.id.spray);
        trail = (ImageView) findViewById(R.id.drag_trail_frame);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchTray15.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                empty.setImageResource(R.drawable.s138_4_hi);
                try {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s138_hi);// create's
