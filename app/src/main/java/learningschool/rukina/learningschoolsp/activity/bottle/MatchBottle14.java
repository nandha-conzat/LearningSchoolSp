 ...
 */
public class MatchBottle14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_14_hi);
        mp = new MediaPlayer();
        playTitle();
        next = (ImageView) findViewById(R.id.imageNext_pa1_v17);
        back = (ImageView) findViewById(R.id.imageback_pa1_v17);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v17);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s102_hi);// create's
