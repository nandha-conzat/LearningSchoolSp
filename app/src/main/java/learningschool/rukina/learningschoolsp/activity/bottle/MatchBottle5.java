 ...
 */
public class MatchBottle5 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_bottle, drop_border;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_5_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_bottle);
        drop_bottle = (RelativeLayout) findViewById(R.id.fixed_bottle_layout);
        drop_border = (RelativeLayout) findViewById(R.id.fixed_border_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        back = (ImageView) findViewById(R.id.imageback_bottle_v2);
        home = (ImageView) findViewById(R.id.imagehome_bottle_v2);
        next = (ImageView) findViewById(R.id.imageNext_bottle_v2);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle5.this);
...
//
        ...
        drop_border.setOnDragListener(new View.OnDragListener() {
