 ...
 */
public class MatchSpoonTwelve extends AppCompatActivity {
    ImageView next, tooth, spoon, pool, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_twevle_hi);
        mp = new MediaPlayer();
        playTitle();

        tooth = (ImageView) findViewById(R.id.tooth_image);
        spoon = (ImageView) findViewById(R.id.spoon_image);
        pool = (ImageView) findViewById(R.id.pool_image);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v12);
        back = (ImageView) findViewById(R.id.imageback_pa2_v12);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v12);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSpoonTwelve.this);
