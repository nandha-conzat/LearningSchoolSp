package learningschool.rukina.learningschoolsp.activity.shirt;
...
/**
 * Created by Nandha on 23-12-2015.
 */
public class MatchShirtTwo extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_shirt, drop_belt;
    TextView text, text1, sucess, sucess1, dispaly;
    int total, total1, failure = 0, failure1 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_two_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shirt);
        drop_shirt = (RelativeLayout) findViewById(R.id.fixed_shirt_layout);
        drop_belt = (RelativeLayout) findViewById(R.id.fixed_belt_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        back = (ImageView) findViewById(R.id.imageback_shirt_v2);
        home = (ImageView) findViewById(R.id.imagehome_shirt_v2);
        next = (ImageView) findViewById(R.id.imageNext_shirt_v2);

        drop_shirt.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirtTwo.this);
...
//
        ...
        drop_belt.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MatchShirtTwo.this,
                        DashBoard_hi.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_plate:
                ...
                Toast.makeText(MatchShirtTwo.this, "Plate", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Plate = new Intent(MatchShirtTwo.this,
            ...
            case R.id.menu_spoon:
                Toast.makeText(MatchShirtTwo.this, "Spoon", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Spoon = new Intent(MatchShirtTwo.this,
                        MatchSpoonOne.class);
            ...
            case R.id.menu_soap:
                Toast.makeText(MatchShirtTwo.this, "Soap", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Soap = new Intent(MatchShirtTwo.this,
                        MatchSoapOne.class);
            ...
            case R.id.menu_shirt:
                Toast.makeText(MatchShirtTwo.this, "Shirt", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Shirt = new Intent(MatchShirtTwo.this,
                        MatchShirtOne.class);
            ...
            case R.id.menu_knife:
                Toast.makeText(MatchShirtTwo.this, "Knife", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Knife = new Intent(MatchShirtTwo.this,
                        MatchKnifeOne.class);
            ...
            case R.id.menu_bottle:
                Toast.makeText(MatchShirtTwo.this, "Bottle", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Bottle = new Intent(MatchShirtTwo.this,
                        MatchBottleOne.class);
                Bottle.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(Bottle);
                return true;
            case R.id.menu_shampoo:
                Toast.makeText(MatchShirtTwo.this, "Shampoo", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Shampoo = new Intent(MatchShirtTwo.this,
            ...
            case R.id.menu_tray:
                Toast.makeText(MatchShirtTwo.this, "Tray", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Tray = new Intent(MatchShirtTwo.this,
                        MatchTrayOne.class);
            ...
            case R.id.menu_lock:
                Toast.makeText(MatchShirtTwo.this, "Lock", Toast.LENGTH_SHORT).show();
                if (mp.isPlaying()) {
                    mp.stop();
                }
                Intent Lock = new Intent(MatchShirtTwo.this,
                        MatchLockOne.class);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_8);// create's
