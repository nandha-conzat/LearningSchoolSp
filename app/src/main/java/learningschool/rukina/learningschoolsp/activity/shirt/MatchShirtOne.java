 ...
 */
public class MatchShirtOne extends AppCompatActivity {
    private MediaPlayer mp;
    LinearLayout ThisShirt, ManLady, Boy, Show;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_shirt_one_hi);
        mp = new MediaPlayer();
        ThisShirt = (LinearLayout) findViewById(R.id.pa1_thisshirt);
        ManLady = (LinearLayout) findViewById(R.id.pa1_manlady);
        Boy = (LinearLayout) findViewById(R.id.pa1_boyshirt);
        Show = (LinearLayout) findViewById(R.id.pa1_showshirt);
        back = (ImageView) findViewById(R.id.imageback_shirt_v1);
        home = (ImageView) findViewById(R.id.imagehome_shirt_v1);
        next = (ImageView) findViewById(R.id.imageNext_shirt_v1);

        playTitle();

        ThisShirt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.shirt_v1_1);// create's
                mp.start(); // starting mediaplayer
            }
        });

        ManLady.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.shirt_v1_2);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        Boy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.shirt_v1_3);// create's
                mp.start(); // starting mediaplayer
            }
        });
        ...
        Show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp.reset();// stops any current playing song
                mp = MediaPlayer.create(getApplicationContext(), R.raw.shirt_v1_4);// create's
                mp.start(); // starting mediaplayer
            }
        });
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_shirt);
