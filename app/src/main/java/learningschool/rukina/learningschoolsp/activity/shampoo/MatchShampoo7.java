 ...
 */
public class MatchShampoo7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shampoo, drop_hotlinks, drop_drawing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shampoo_frame);
        drop_shampoo = (RelativeLayout) findViewById(R.id.fixed_shampoo_layout);
        drop_hotlinks = (RelativeLayout) findViewById(R.id.fixed_hotlinks_layout);
        drop_drawing = (RelativeLayout) findViewById(R.id.fixed_drawing_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShampoo7.this);
        ...
        drop_hotlinks.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_drawing.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s112_hi);// create's
