 ...
 */
public class MatchKnife4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_knife, drop_knob;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_4_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_knife);
        drop_knife = (RelativeLayout) findViewById(R.id.fixed_knife_layout);
        drop_knob = (RelativeLayout) findViewById(R.id.fixed_beans_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa5_v4);
        back = (ImageView) findViewById(R.id.imageback_pa5_v4);
        home = (ImageView) findViewById(R.id.imagehome_pa5_v4);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnife4.this);
...
//
        ...
        drop_knob.setOnDragListener(new View.OnDragListener() {
