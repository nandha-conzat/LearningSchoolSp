 ...
 */
public class MatchTrayOne extends AppCompatActivity {
    private MediaPlayer mp;
    LinearLayout tray1, tray2, tray3;
    ImageView back, home, next;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_tray_one_hi);
        mp = new MediaPlayer();
        tray1 = (LinearLayout) findViewById(R.id.pa1_tray1);
        tray2 = (LinearLayout) findViewById(R.id.pa1_tray2);
        tray3 = (LinearLayout) findViewById(R.id.pa1_tray3);
        back = (ImageView) findViewById(R.id.imageback_tray_v1);
        home = (ImageView) findViewById(R.id.imagehome_tray_v1);
        next = (ImageView) findViewById(R.id.imageNext_tray_v1);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem item3  = menu.findItem(R.id.menu_tray);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.tray_v1);// create's
