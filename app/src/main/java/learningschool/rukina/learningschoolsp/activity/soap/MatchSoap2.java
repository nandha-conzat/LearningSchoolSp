 ...
 */
public class MatchSoap2 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_soap, drop_soup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_2_hi);
        ...
        drop_soup = (RelativeLayout) findViewById(R.id.fixed_soup_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSoap2.this);
...
//
        ...
        drop_soup.setOnDragListener(new View.OnDragListener() {
