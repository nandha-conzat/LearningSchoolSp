 ...
 */
public class MatchTray9 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tray, drop_bray, drop_lay, drop_play, drop_fray, drop_grey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_9_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_tray_frame);
        drop_tray = (RelativeLayout) findViewById(R.id.fixed_tary_layout);
        drop_bray = (RelativeLayout) findViewById(R.id.fixed_bray_layout);
        drop_lay = (RelativeLayout) findViewById(R.id.fixed_lay_layout);
        drop_play = (RelativeLayout) findViewById(R.id.fixed_play_frame);
        drop_fray = (RelativeLayout) findViewById(R.id.fixed_fray_layout);
        drop_grey = (RelativeLayout) findViewById(R.id.fixed_grey_frame);
        ...
        drop_tray.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray9.this);
        ...
        drop_bray.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_lay.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_play.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_fray.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_grey.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s132_hi);// create's
