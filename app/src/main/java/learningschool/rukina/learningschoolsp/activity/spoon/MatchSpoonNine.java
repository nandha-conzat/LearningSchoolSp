package learningschool.rukina.learningschoolsp.activity.spoon;
 ...
 */
public class MatchSpoonNine extends AppCompatActivity {
    ImageView next, back, home, school, sponge, fixSpoon, spoil, shoot, sprout, spindle, drag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_nine_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.spoon_image9);
        school = (ImageView) findViewById(R.id.school_image9);
        sponge = (ImageView) findViewById(R.id.sponge_image9);
        fixSpoon = (ImageView) findViewById(R.id.spoon_image9_fixed);
        spoil = (ImageView) findViewById(R.id.spoil_image9);
        shoot = (ImageView) findViewById(R.id.shoot_image9);
        sprout = (ImageView) findViewById(R.id.sprout_image9);
        spindle = (ImageView) findViewById(R.id.spindle_image9);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v9);
        back = (ImageView) findViewById(R.id.imageback_pa2_v9);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v9);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);

        fixSpoon.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonNine.this);
...
//
        ...
        school.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        sponge.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        spoil.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        shoot.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        sprout.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        spindle.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s27n28n29);// create's
