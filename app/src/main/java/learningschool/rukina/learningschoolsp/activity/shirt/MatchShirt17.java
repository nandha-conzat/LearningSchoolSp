 ...
 */
public class MatchShirt17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_17_hi);
        mp = new MediaPlayer();
        play = (ImageView) findViewById(R.id.rhyme_play);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v11);
        back = (ImageView) findViewById(R.id.imageback_pa1_v11);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v11);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s166_five);// create's
