 ...
 */
public class MatchSpoonEleven extends AppCompatActivity {
    ImageView next, spoon, fork, back, home;
    RelativeLayout find_fork, find_spoon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_eleven_hi);
        mp = new MediaPlayer();
        playTitle();

        find_fork = (RelativeLayout) findViewById(R.id.find_fork_layout);
        find_spoon = (RelativeLayout) findViewById(R.id.find_spoon_layout);
        ...
        spoon = (ImageView) findViewById(R.id.find_spoon);
        fork = (ImageView) findViewById(R.id.find_fork);

        find_spoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSpoonEleven.this);
        ...
        find_fork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s31);// create's
