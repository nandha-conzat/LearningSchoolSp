 ...
 */
public class MatchKey12 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView pay, bay, key, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_12_hi);
        mp = new MediaPlayer();
        playTitle();

        pay = (TextView) findViewById(R.id.txt_pay);
        bay = (TextView) findViewById(R.id.txt_bay);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchKey12.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s168_hi);// create's
