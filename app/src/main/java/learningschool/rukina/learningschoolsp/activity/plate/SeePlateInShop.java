 ...
 */
public class SeePlateInShop extends AppCompatActivity {
    private MediaPlayer mp;
    ImageView back, home, next, yes, no;
    ImageView spoon, plate, bucket, grinder;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.see_plate_in_shop_hi);
        mp = new MediaPlayer();
        back = (ImageView) findViewById(R.id.imageback_pa1_v19);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v19);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v19);
        spoon = (ImageView) findViewById(R.id.list_spoon);
        plate = (ImageView) findViewById(R.id.list_plate);
        bucket = (ImageView) findViewById(R.id.list_bucket);
        ...
        plate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                playPerfect();
                cdd = new CustomDialogClass_hi(SeePlateInShop.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v19);// create's
