 ...
 */
public class MatchShirt3 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shirt, drop_child;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_3_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shirt_word_card);
        drop_shirt = (RelativeLayout) findViewById(R.id.fixed_shirt_word_card_layout);
        drop_child = (RelativeLayout) findViewById(R.id.fixed_child_word_card_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v3);
        back = (ImageView) findViewById(R.id.imageback_pa4_v3);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v3);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirt3.this);
...
//
        ...
        drop_child.setOnDragListener(new View.OnDragListener() {
