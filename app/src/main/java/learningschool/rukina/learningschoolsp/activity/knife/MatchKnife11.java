 ...
 */
public class MatchKnife11 extends AppCompatActivity {
    ImageView drag, next, back, home, knife, cutter, board;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_11_hi);
        mp = new MediaPlayer();
        playTitle();

        knife = (ImageView) findViewById(R.id.knife_image);
        cutter = (ImageView) findViewById(R.id.cutter_image);
        board = (ImageView) findViewById(R.id.board_image);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchKnife11.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s84_hi);// create's
