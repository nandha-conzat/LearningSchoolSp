 ...
 */
public class MatchShampoo3 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_bottle, drop_bag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_3_hi);
        mp = new MediaPlayer();
        playTitle();
        ...
        drop_bag = (RelativeLayout) findViewById(R.id.fixed_bag_word_card_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShampoo3.this);
...
//
        ...
        drop_bag.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s108_hi);// create's
