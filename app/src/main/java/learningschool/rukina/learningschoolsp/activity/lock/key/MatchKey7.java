 ...
 */
public class MatchKey7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_key, drop_pet, drop_lot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_key_frame);
        drop_key = (RelativeLayout) findViewById(R.id.fixed_key_layout);
        drop_pet = (RelativeLayout) findViewById(R.id.fixed_pet_layout);
        drop_lot = (RelativeLayout) findViewById(R.id.fixed_lot_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey7.this);
        ...
        drop_pet.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_lot.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s163_hi);// create's
