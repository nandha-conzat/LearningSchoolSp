 ...
 */
public class MatchShampoo13 extends AppCompatActivity {
    ImageView next, back, home, shampoos, shapes, stickers, basket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_13_hi);
        mp = new MediaPlayer();
        playTitle();
        ...
        shampoos = (ImageView) findViewById(R.id.shampoo);
        shapes = (ImageView) findViewById(R.id.shapes);
        stickers = (ImageView) findViewById(R.id.stickers);
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass_hi(MatchShampoo13.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s118_hi);// create's
