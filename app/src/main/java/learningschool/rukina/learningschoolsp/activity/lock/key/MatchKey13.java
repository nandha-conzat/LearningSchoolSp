 ...
 */
public class MatchKey13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_13_hi);
        mp = new MediaPlayer();
        playTitle();
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s169_hi);// create's
