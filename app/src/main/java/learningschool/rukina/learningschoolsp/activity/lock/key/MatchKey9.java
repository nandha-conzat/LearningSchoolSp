 ...
 */
public class MatchKey9 extends AppCompatActivity {

    ImageView next, home, back, drag;
    private MediaPlayer mp;
    RelativeLayout key, dye, lay, day, gay;
    TextView dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_9_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.key_image);
        key = (RelativeLayout) findViewById(R.id.key_layout13);
        dye = (RelativeLayout) findViewById(R.id.dye_layout13);
        lay = (RelativeLayout) findViewById(R.id.lay_layout13);
        day = (RelativeLayout) findViewById(R.id.day_layout13);
        gay = (RelativeLayout) findViewById(R.id.gay_layout13);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey9.this);
        ...
        dye.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        lay.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        day.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        gay.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s165_hi);// create's
