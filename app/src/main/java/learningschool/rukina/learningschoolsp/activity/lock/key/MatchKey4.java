 ...
 */
public class MatchKey4 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_key, drop_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_4_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_key);
        drop_key = (RelativeLayout) findViewById(R.id.fixed_key_layout);
        drop_text = (RelativeLayout) findViewById(R.id.fixed_text_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey4.this);
...
//
        ...
        drop_text.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s160_hi);// create's
