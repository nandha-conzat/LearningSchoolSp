 ...
 */
public class MatchBottle7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_bottle, drop_ghee, drop_power;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_bottle_frame);
        drop_bottle = (RelativeLayout) findViewById(R.id.fixed_bottle_layout);
        drop_ghee = (RelativeLayout) findViewById(R.id.fixed_ghee_layout);
        drop_power = (RelativeLayout) findViewById(R.id.fixed_power_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle7.this);
        ...
        drop_ghee.setOnDragListener(new View.OnDragListener() {
        ...
        drop_power.setOnDragListener(new View.OnDragListener() {
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s95_hi);// create's
