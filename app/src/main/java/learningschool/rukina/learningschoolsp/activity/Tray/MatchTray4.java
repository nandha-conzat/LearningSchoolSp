 ...
 */
public class MatchTray4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tray, drop_purse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_4_hi);
        ...
        drop_purse = (RelativeLayout) findViewById(R.id.fixed_purse_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray4.this);
...
//
        ...
        drop_purse.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s127_hi);// create's
