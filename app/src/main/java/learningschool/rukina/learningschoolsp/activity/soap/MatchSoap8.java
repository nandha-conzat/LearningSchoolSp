 ...
 */
public class MatchSoap8 extends AppCompatActivity {
    ImageView next, back, home, soap, shop, sand, fixSoap, soup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_8_hi);
        mp = new MediaPlayer();
        playTitle();

        soap = (ImageView) findViewById(R.id.soap_image8);
        shop = (ImageView) findViewById(R.id.shop_image8);
        sand = (ImageView) findViewById(R.id.sand_image8);
        fixSoap = (ImageView) findViewById(R.id.soap_image8_fix);
        soup = (ImageView) findViewById(R.id.soup_image8_fixed);

        next = (ImageView) findViewById(R.id.imageNext_pa3_v8);
        back = (ImageView) findViewById(R.id.imageback_pa3_v8);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v8);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSoap8.this);
        ...
        fixSoap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s47);// create's
