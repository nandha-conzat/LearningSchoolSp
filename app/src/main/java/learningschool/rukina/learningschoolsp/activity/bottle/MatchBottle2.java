 ...
 */
public class MatchBottle2 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_bottle, drop_paste;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onDrag(View v, DragEvent event) {
                ...
                switch (action) {
                    ...
                    case DragEvent.ACTION_DROP: {
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle2.this);
        ...
        drop_paste.setOnDragListener(new View.OnDragListener() {
