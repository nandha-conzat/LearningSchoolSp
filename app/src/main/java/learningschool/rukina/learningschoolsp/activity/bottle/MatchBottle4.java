 ...
 */
public class MatchBottle4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_bottle, drop_squash;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_4_hi);
        mp = new MediaPlayer();
        ...
        drop_squash = (RelativeLayout) findViewById(R.id.fixed_squash_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa5_v2);
        back = (ImageView) findViewById(R.id.imageback_pa5_v2);
        home = (ImageView) findViewById(R.id.imagehome_pa5_v2);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchBottle4.this);
...
//
        ...
        drop_squash.setOnDragListener(new View.OnDragListener() {
