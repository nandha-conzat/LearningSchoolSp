 ...
 */
public class MatchKnife10 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView knife, knight, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_10_hi);
        mp = new MediaPlayer();
        playTitle();

        knife = (TextView) findViewById(R.id.txt_shirt);
        knight = (TextView) findViewById(R.id.txt_photo);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchKnife10.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s83_hi);// create's
