 ...
 */
public class MatchSoap9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_9_hi);
        mp = new MediaPlayer();

        play = (ImageView) findViewById(R.id.rhyme_play);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v9);
        back = (ImageView) findViewById(R.id.imageback_pa3_v9);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v9);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.bluebird);// create's
