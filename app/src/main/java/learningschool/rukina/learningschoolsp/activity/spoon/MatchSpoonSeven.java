 ...
 */
public class MatchSpoonSeven extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tumbler, drop_stove, drop_spoon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_seven_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_spoon_frame);
        drop_tumbler = (RelativeLayout) findViewById(R.id.fixed_tumbler_frame);
        drop_stove = (RelativeLayout) findViewById(R.id.fixed_stove_layout);
        drop_spoon = (RelativeLayout) findViewById(R.id.fixed_spoon_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v7);
        back = (ImageView) findViewById(R.id.imageback_pa2_v7);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v7);

        drop_spoon.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonSeven.this);
        ...
        drop_tumbler.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_stove.setOnDragListener(new View.OnDragListener() {
