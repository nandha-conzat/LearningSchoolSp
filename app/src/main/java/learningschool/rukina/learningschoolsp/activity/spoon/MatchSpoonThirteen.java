 ...
 */
public class MatchSpoonThirteen extends AppCompatActivity {
    ImageView next, spell, sprite, spool, school, spoon, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_thirteen_hi);
        mp = new MediaPlayer();
        playTitle();

        spell = (ImageView) findViewById(R.id.spell_image13);
        sprite = (ImageView) findViewById(R.id.sprite_image13);
        spool = (ImageView) findViewById(R.id.spool_image13);
        school = (ImageView) findViewById(R.id.school_image13);
        spoon = (ImageView) findViewById(R.id.spoon_image13);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSpoonThirteen.this);
        ...
        spool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s32n33);// create's
