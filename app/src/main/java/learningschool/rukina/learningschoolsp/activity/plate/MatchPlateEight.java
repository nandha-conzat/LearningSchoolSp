 ...
 */
public class MatchPlateEight extends AppCompatActivity {
    ImageView next, plate, cups,back, home;
    RelativeLayout find_plate, find_cups;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_eight_hi);
        mp = new MediaPlayer();
        playTitle();

        find_plate = (RelativeLayout) findViewById(R.id.find_plate_layout);
        find_cups = (RelativeLayout) findViewById(R.id.find_cups_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v12);
        back = (ImageView) findViewById(R.id.imageback_pa1_v12);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v12);
        plate = (ImageView) findViewById(R.id.find_plate);
        cups = (ImageView) findViewById(R.id.find_cups);

        find_plate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchPlateEight.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                plate.setImageResource(R.drawable.home_plate);
                cups.setImageResource(R.drawable.v12_a);
        ...
        find_cups.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
                playWrong();
                cups.setImageResource(R.drawable.v12_b);
                plate.setImageResource(R.drawable.v12_a);
            }
        });
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v10n11);// create's
