...
import learningschool.rukina.learningschoolsp.activity.Tray.MatchTray12;
 ...
 */
public class MatchLock11 extends AppCompatActivity {
    ImageView next, lock, stem, back, home;
    RelativeLayout find_lock, find_stem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_11_hi);
        mp = new MediaPlayer();
        playTitle();

        find_lock = (RelativeLayout) findViewById(R.id.find_lock_layout);
        find_stem = (RelativeLayout) findViewById(R.id.find_stem_layout);
        ...
        find_lock.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass_hi(MatchLock11.this);
        ...
        find_stem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s151_hi);// create's
