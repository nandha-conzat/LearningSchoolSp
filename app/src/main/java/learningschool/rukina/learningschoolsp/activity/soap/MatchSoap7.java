 ...
 */
public class MatchSoap7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_soap, drop_surf, drop_swipe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_soap_frame);
        drop_soap = (RelativeLayout) findViewById(R.id.fixed_soap_layout);
        drop_surf = (RelativeLayout) findViewById(R.id.fixed_surf_frame);
        drop_swipe = (RelativeLayout) findViewById(R.id.fixed_swipe_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v7);
        back = (ImageView) findViewById(R.id.imageback_pa3_v7);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v7);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSoap7.this);
        ...
        drop_surf.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_swipe.setOnDragListener(new View.OnDragListener() {
