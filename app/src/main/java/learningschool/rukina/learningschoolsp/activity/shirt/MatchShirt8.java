...
/**
 * Created by Nandha on 28-12-2015.
 */
public class MatchShirt8 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    RelativeLayout drop_shirt, drop_jeep, drop_pant, drop_crook, drop_jeans;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shirt);
        drop_shirt = (RelativeLayout) findViewById(R.id.fixed_shirt_layout);
        drop_jeep = (RelativeLayout) findViewById(R.id.fixed_jeep_layout);
        drop_pant = (RelativeLayout) findViewById(R.id.fixed_pant_layout);
        drop_crook = (RelativeLayout) findViewById(R.id.fixed_crook_layout);
        drop_jeans = (RelativeLayout) findViewById(R.id.fixed_jeans_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v8);
        back = (ImageView) findViewById(R.id.imageback_pa4_v8);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v8);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirt8.this);
        ...
        drop_jeep.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_pant.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_crook.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_jeans.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s63_hi);// create's
