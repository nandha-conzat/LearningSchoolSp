 ...
 */
public class MatchTray12 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView tray, plate, spoon, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_12_hi);
        mp = new MediaPlayer();
        playTitle();

        tray = (TextView) findViewById(R.id.txt_tray);
        plate = (TextView) findViewById(R.id.txt_plate);
        spoon = (TextView) findViewById(R.id.txt_spoon);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchTray12.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s135_hi);// create's
