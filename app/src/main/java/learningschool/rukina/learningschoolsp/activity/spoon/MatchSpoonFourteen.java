 ...
 */
public class MatchSpoonFourteen extends AppCompatActivity {
    private MediaPlayer mp;
    ImageView back, home, next, yes, no;
    TextView dispaly;
    private static int SPLASH_TIME_OUT = 1000;
    ImageView mixie, grinder, oven, spoon, mug;
    CustomDialogClass_hi cdd;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_spoon_fourteen_hi);
        mp = new MediaPlayer();
        back = (ImageView) findViewById(R.id.imageback_pa2_v14);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v14);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v14);
        yes = (ImageView) findViewById(R.id.yes);
        no = (ImageView) findViewById(R.id.no);

        spoon = (ImageView) findViewById(R.id.list_spoon);
        mug = (ImageView) findViewById(R.id.list_mug);
        oven = (ImageView) findViewById(R.id.list_oven);
        mixie = (ImageView) findViewById(R.id.list_mixie);
        grinder = (ImageView) findViewById(R.id.list_grinder);
        ...
        spoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSpoonFourteen.this);
        ...
        mixie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s34);// create's
