 ...
 */
public class MatchShampoo9 extends AppCompatActivity {
    ImageView drag, next,back, home;
    RelativeLayout drop_should, drop_bamboo, drop_shampoo, drop_pooling, drop_sample, drop_boost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_9_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_knife_frame);
        drop_should = (RelativeLayout) findViewById(R.id.fixed_should_layout);
        drop_bamboo = (RelativeLayout) findViewById(R.id.fixed_bamboo_layout);
        drop_pooling = (RelativeLayout) findViewById(R.id.fixed_pooling_frame);
        drop_shampoo = (RelativeLayout) findViewById(R.id.fixed_shampoo_layout);
        drop_sample = (RelativeLayout) findViewById(R.id.fixed_sample_layout);
        drop_boost = (RelativeLayout) findViewById(R.id.fixed_boost_frame);
        ...
        drop_shampoo.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShampoo9.this);
        ...
        drop_should.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_bamboo.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_pooling.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_sample.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_boost.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s114_hi);// create's
