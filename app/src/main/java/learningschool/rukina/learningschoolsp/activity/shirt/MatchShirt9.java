 ...
 */
public class MatchShirt9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_9_hi);
        mp = new MediaPlayer();

        play = (ImageView) findViewById(R.id.rhyme_play);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v9);
        back = (ImageView) findViewById(R.id.imageback_pa4_v9);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v9);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.baa);// create's
