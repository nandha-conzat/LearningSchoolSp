 ...
 */
public class MatchKey8 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_key, drop_kit, drop_bye;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_key_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_key_frame);
        drop_key = (RelativeLayout) findViewById(R.id.fixed_key_layout);
        drop_kit = (RelativeLayout) findViewById(R.id.fixed_kit_layout);
        drop_bye = (RelativeLayout) findViewById(R.id.fixed_bye_frame);
        ...
        drop_key.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey8.this);
        ...
        drop_kit.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_bye.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s164_hi);// create's
