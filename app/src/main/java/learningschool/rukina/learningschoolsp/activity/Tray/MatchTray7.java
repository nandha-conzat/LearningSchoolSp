 ...
 */
public class MatchTray7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_rose, drop_tray, drop_girl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_tray_frame);
        drop_tray = (RelativeLayout) findViewById(R.id.fixed_tray_layout);
        drop_rose = (RelativeLayout) findViewById(R.id.fixed_rose_layout);
        drop_girl = (RelativeLayout) findViewById(R.id.fixed_girl_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray7.this);
        ...
        drop_girl.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_rose.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s130_hi);// create's
