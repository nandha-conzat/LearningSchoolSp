 ...
 */
public class MatchSpoonTen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_ten_hi);
        mp = new MediaPlayer();

        play = (ImageView) findViewById(R.id.rhyme_play);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v10);
        back = (ImageView) findViewById(R.id.imageback_pa2_v10);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v10);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.london_bridge);// create's
