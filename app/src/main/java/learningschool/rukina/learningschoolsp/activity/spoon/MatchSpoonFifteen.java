 ...
 */
public class MatchSpoonFifteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_fifteen_hi);
        mp = new MediaPlayer();
        playTitle();
        next = (ImageView) findViewById(R.id.imageNext_pa2_v15);
        back = (ImageView) findViewById(R.id.imageback_pa2_v15);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v15);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s35);// create's
