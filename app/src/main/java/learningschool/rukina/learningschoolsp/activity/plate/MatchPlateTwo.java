...
/**
 * Created by COBURG DESIGN on 18-12-2015.
 */
public class MatchPlateTwo extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout drop_palte, drop_box;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_two_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_plate);
        drop_palte = (RelativeLayout) findViewById(R.id.fixed_plate_layout);
        drop_box = (RelativeLayout) findViewById(R.id.fixed_box_layout);
        dispaly = (TextView)findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v5);
        back = (ImageView) findViewById(R.id.imageback_pa1_v5);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v5);
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass_hi(MatchPlateTwo.this);
...
//
        ...
        drop_box.setOnDragListener(new View.OnDragListener() {
