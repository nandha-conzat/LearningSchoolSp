 ...
 */
public class MatchBottle11 extends AppCompatActivity {
    ImageView next, bottle, door,back, home;
    RelativeLayout find_door, find_bottle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_11_hi);
        mp = new MediaPlayer();
        playTitle();

        find_door = (RelativeLayout) findViewById(R.id.find_fork_layout);
        find_bottle = (RelativeLayout) findViewById(R.id.find_spoon_layout);
        ...
        bottle = (ImageView) findViewById(R.id.find_spoon);
        door = (ImageView) findViewById(R.id.find_fork);

        find_bottle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchBottle11.this);
        ...
        find_door.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s99_hi);// create's
