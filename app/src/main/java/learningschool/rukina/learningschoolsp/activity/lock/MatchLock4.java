 ...
 */
public class MatchLock4 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_lock, drop_sheet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_4_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_lock);
        drop_lock = (RelativeLayout) findViewById(R.id.fixed_lock_layout);
        drop_sheet = (RelativeLayout) findViewById(R.id.fixed_sheet_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v2);
        back = (ImageView) findViewById(R.id.imageback_pa3_v2);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v2);
            ...
            public boolean onDrag(View v, DragEvent event) {
                ...
                switch (action) {
                    ...
                    case DragEvent.ACTION_DROP: {
                        ...
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchLock4.this);
        ...
        drop_sheet.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s144_hi);// create's
