 ...
 */
public class MatchTray8 extends AppCompatActivity {
    ImageView drag, next,back, home;
    RelativeLayout drop_tram, drop_tray, drop_trim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_tray_frame);
        drop_tray = (RelativeLayout) findViewById(R.id.fixed_tray_layout);
        drop_trim = (RelativeLayout) findViewById(R.id.fixed_trim_frame);
        drop_tram = (RelativeLayout) findViewById(R.id.fixed_tram_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray8.this);
        ...
        drop_tram.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_trim.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s131_hi);// create's
