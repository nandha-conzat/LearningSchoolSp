 ...
 */
public class MatchSoap15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_15_hi);
        mp = new MediaPlayer();
        ...
        //views to drag
        option1 = (TextView) findViewById(R.id.plate);
        option2 = (TextView) findViewById(R.id.soap);
        option3 = (TextView) findViewById(R.id.spoon);
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        if (userEntered.equals("A .B .C .")) {
                            ...
                            cdd = new CustomDialogClass_hi(MatchSoap15.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s54);// create's
