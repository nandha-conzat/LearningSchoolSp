 ...
 */
public class MatchPlateThree extends AppCompatActivity {

    ImageView drag, next, back, home;
    RelativeLayout drop_palte, drop_plait;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_three_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_plate_word_card_);
        drop_palte = (RelativeLayout) findViewById(R.id.fixed_plate_word_card_layout);
        drop_plait = (RelativeLayout) findViewById(R.id.fixed_plait_word_card_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v6);
        back = (ImageView) findViewById(R.id.imageback_pa1_v6);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v6);


        drop_palte.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchPlateThree.this);
...
//
        ...
        drop_plait.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_v6);// create's
