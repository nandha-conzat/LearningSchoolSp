 ...
 */
public class MatchKey5 extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_key, drop_tie;
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKey5.this);
...
//
        ...
        drop_tie.setOnDragListener(new View.OnDragListener() {
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s161_hi);// create's
