 ...
 */
public class MatchPlateFour extends AppCompatActivity {
    ImageView cartoon_plate,cartoon,next,back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_four_hi);
        cartoon_plate = (ImageView)findViewById(R.id.cartoon_plate);
        cartoon = (ImageView)findViewById(R.id.cartoon);
        next = (ImageView)findViewById(R.id.imageNext_pa1_v7);
        back = (ImageView) findViewById(R.id.imageback_pa1_v7);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v7);
        mp = new MediaPlayer();
        playTitle();

        cartoon_plate.setOnClickListener(new View.OnClickListener() {
            @Override
