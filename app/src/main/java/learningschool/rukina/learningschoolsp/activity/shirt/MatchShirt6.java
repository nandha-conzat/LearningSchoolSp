 ...
 */
public class MatchShirt6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_6_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shirt_frame);
        drop_shirt = (RelativeLayout) findViewById(R.id.fixed_shirt_layout);
        drop_collar = (RelativeLayout) findViewById(R.id.fixed_collar_frame);
        drop_paper = (RelativeLayout) findViewById(R.id.fixed_paper_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v6);
        back = (ImageView) findViewById(R.id.imageback_pa4_v6);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v6);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirt6.this);
        ...
        drop_collar.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_paper.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s61);// create's
