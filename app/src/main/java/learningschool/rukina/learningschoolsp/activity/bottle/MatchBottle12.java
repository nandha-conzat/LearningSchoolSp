 ...
 */
public class MatchBottle12 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView bottle, plug, read, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_12_hi);
        mp = new MediaPlayer();
        playTitle();

        bottle = (TextView) findViewById(R.id.txt_bottle);
        plug = (TextView) findViewById(R.id.txt_plug);
        read = (TextView) findViewById(R.id.txt_read);
        ...
        bottle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchBottle12.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s100_hi);// create's
