 ...
 */
public class MatchBottle16 extends AppCompatActivity {
    TextView option_a1, option_a2, option_a3, option_a4, option_a5, option_a6, option_a7,
            ...
            choice_c1, choice_c2, choice_c3, choice_c4, choice_c5, choice_c6, choice_c7,
            choice_d1, choice_d2, choice_d3, choice_d4, choice_d5, choice_d6, choice_d7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_bottle_16_hi);
        mp = new MediaPlayer();
        ...
        //views to drop onto
        choice_c1 = (TextView) findViewById(R.id.option_c1);
        choice_c2 = (TextView) findViewById(R.id.option_c2);
        choice_c3 = (TextView) findViewById(R.id.option_c3);
        choice_c4 = (TextView) findViewById(R.id.option_c4);
        choice_c5 = (TextView) findViewById(R.id.option_c5);
        choice_c6 = (TextView) findViewById(R.id.option_c6);
        ...
        //set drag listeners
        choice_c1.setOnTouchListener(new ChoiceTouchListener());
        choice_c2.setOnTouchListener(new ChoiceTouchListener());
        choice_c3.setOnTouchListener(new ChoiceTouchListener());
        choice_c4.setOnTouchListener(new ChoiceTouchListener());
        choice_c5.setOnTouchListener(new ChoiceTouchListener());
        choice_c6.setOnTouchListener(new ChoiceTouchListener());
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String f = option_a6.getText().toString().trim();
                        ...
                        userEntered = "" + a + b + c + d + e + f + a1 + b1 + c1 + d1 + e1;
                        if (userEntered.equals("b.ot.t.l.ek.n.i.f.e")) {
                            playPerfect();
                            cdd = new CustomDialogClass_hi(MatchBottle16.this);
