 ...
 */
public class MatchSoap11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_11_hi);
        mp = new MediaPlayer();
        playTitle();

        soap = (ImageView) findViewById(R.id.soap_image);
        ring = (ImageView) findViewById(R.id.ring_image);
        basin = (ImageView) findViewById(R.id.basin_image);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v11);
        back = (ImageView) findViewById(R.id.imageback_pa3_v11);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v11);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSoap11.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s50);// create's
