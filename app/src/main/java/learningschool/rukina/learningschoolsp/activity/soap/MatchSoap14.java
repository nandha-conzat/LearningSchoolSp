 ...
 */
public class MatchSoap14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_14_hi);
        mp = new MediaPlayer();
        next = (ImageView) findViewById(R.id.imageNext_pa3_v14);
        back = (ImageView) findViewById(R.id.imageback_pa3_v14);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v14);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (dropTarget.getText().toString().charAt(0) == dropped.getText().toString().charAt(0)) {
                        ...
                        String p = choice4.getText().toString().trim();
                        //String n = choice5.getText().toString().trim();

                        userEntered = "" + s + o + a + p;
                        if (userEntered.equals("s .o .a .p .")) {
                            playPerfect();
                            cdd = new CustomDialogClass_hi(MatchSoap14.this);
