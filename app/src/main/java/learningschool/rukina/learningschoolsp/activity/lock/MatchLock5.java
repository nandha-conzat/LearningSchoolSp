 ...
 */
public class MatchLock5 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_lock, drop_torch;
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchLock5.this);
        ...
        drop_torch.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s145_hi);// create's
