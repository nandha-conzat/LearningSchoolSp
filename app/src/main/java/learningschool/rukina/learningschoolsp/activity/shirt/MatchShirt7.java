 ...
 */
public class MatchShirt7 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shirt, drop_shield, drop_skin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_7_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shirt_frame);
        drop_shirt = (RelativeLayout) findViewById(R.id.fixed_shirt_layout);
        drop_shield = (RelativeLayout) findViewById(R.id.fixed_shield_layout);
        drop_skin = (RelativeLayout) findViewById(R.id.fixed_skin_frame);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v7);
        back = (ImageView) findViewById(R.id.imageback_pa4_v7);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v7);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirt7.this);
        ...
        drop_shield.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_skin.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s62);// create's
