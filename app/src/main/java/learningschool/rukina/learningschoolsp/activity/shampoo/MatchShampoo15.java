 ...
 */
public class MatchShampoo15 extends AppCompatActivity {
    ImageView drag, next, back, home, shuttle, shampoo, bamboo, shooter, empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_15_hi);
        mp = new MediaPlayer();
        playTitle();

        shuttle = (ImageView) findViewById(R.id.drag_shuttle_frame);
        shampoo = (ImageView) findViewById(R.id.fixed_shampoo);
        bamboo = (ImageView) findViewById(R.id.collar_bamboo);
        shooter = (ImageView) findViewById(R.id.drag_shooter_frame_fixed);
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass_hi(MatchShampoo15.this);
                cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                cdd.show();
                empty.setImageResource(R.drawable.s120_4_hi);
                try {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s120_hi);// create's
