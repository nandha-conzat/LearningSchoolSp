 ...
 */
public class MatchTray3 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_tray, drop_train;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_3_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_tray_word_card);
        drop_tray = (RelativeLayout) findViewById(R.id.fixed_tray_word_card_layout);
        drop_train = (RelativeLayout) findViewById(R.id.fixed_train_word_card_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa3_v4);
        back = (ImageView) findViewById(R.id.imageback_pa3_v4);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v4);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchTray3.this);
...
//
        ...
        drop_train.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s126_hi);// create's
