 ...
 */
public class MatchLock3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_3_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_lock_word_card);
        drop_tray = (RelativeLayout) findViewById(R.id.fixed_lock_word_card_layout);
        drop_train = (RelativeLayout) findViewById(R.id.fixed_lime_word_card_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchLock3.this);
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s143_hi);// create's
