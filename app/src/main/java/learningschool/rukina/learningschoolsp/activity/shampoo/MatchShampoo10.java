 ...
 */
public class MatchShampoo10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_10_hi);
        mp = new MediaPlayer();
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s115_hickory_dickory_hi);// create's
