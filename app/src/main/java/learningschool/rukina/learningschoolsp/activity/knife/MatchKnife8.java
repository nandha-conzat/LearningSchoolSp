 ...
 */
public class MatchKnife8 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_wife, drop_knife, drop_life, drop_trifle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_knife_8_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_knife_frame);
        drop_wife = (RelativeLayout) findViewById(R.id.fixed_wife_layout);
        drop_life = (RelativeLayout) findViewById(R.id.fixed_life_layout);
        drop_knife = (RelativeLayout) findViewById(R.id.fixed_knife_frame);
        drop_trifle = (RelativeLayout) findViewById(R.id.fixed_trifle_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchKnife8.this);
        ...
        drop_wife.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_trifle.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_life.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s81_hi);// create's
