 ...
 */
public class MatchLock13 extends AppCompatActivity {
    ImageView next, stock, flock, dock, lock, lick, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_13_hi);
        mp = new MediaPlayer();
        playTitle();

        stock = (ImageView) findViewById(R.id.stock_image13);
        flock = (ImageView) findViewById(R.id.flock_image13);
        dock = (ImageView) findViewById(R.id.dock_image13);
        lock = (ImageView) findViewById(R.id.lock_image13);
        lick = (ImageView) findViewById(R.id.lick_image13);
...
//                dispaly.setTextColor(Color.GREEN);
                ...
                cdd = new CustomDialogClass_hi(MatchLock13.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s153_hi);// create's
