 ...
 */
public class MatchShirt11 extends AppCompatActivity {
    ImageView drag, next, back, home, shirt, shout, shark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_11_hi);
        mp = new MediaPlayer();
        playTitle();

        shirt = (ImageView) findViewById(R.id.shirt_image);
        shout = (ImageView) findViewById(R.id.shout_image);
        shark = (ImageView) findViewById(R.id.shark_image);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v11);
        back = (ImageView) findViewById(R.id.imageback_pa4_v11);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v11);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchShirt11.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s66_hi);// create's
