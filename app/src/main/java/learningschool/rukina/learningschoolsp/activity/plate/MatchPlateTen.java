 ...
 */
public class MatchPlateTen extends AppCompatActivity {
    ImageView next, plastic, dress, plate, cream, butter, back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_ten_hi);
        mp = new MediaPlayer();
        playTitle();

        plastic = (ImageView) findViewById(R.id.plastic_image14);
        dress = (ImageView) findViewById(R.id.dress_image14);
        plate = (ImageView) findViewById(R.id.plate_image14);
        cream = (ImageView) findViewById(R.id.cream_image14);
        butter = (ImageView) findViewById(R.id.butter_image14);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v14);
        back = (ImageView) findViewById(R.id.imageback_pa1_v14);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v14);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchPlateTen.this);
