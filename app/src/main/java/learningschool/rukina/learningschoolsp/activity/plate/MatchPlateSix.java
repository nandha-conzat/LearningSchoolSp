 ...
 */
public class MatchPlateSix extends AppCompatActivity {
    ImageView drag, next,back, home;
    RelativeLayout drop_plot, drop_plane, drop_plate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_six_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_plate_heart);
        drop_plot = (RelativeLayout) findViewById(R.id.fixed_plot_layout);
        drop_plane = (RelativeLayout) findViewById(R.id.fixed_plane_layout);
        drop_plate = (RelativeLayout) findViewById(R.id.fixed_plate_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa1_v9);
        back = (ImageView) findViewById(R.id.imageback_pa1_v9);
        home = (ImageView) findViewById(R.id.imagehome_pa1_v9);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchPlateSix.this);
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_plane.setOnDragListener(new View.OnDragListener() {
