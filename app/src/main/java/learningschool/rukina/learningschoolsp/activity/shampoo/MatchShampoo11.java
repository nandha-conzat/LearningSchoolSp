 ...
 */
public class MatchShampoo11 extends AppCompatActivity {
    ImageView next, bottle, door, back, home;
    RelativeLayout find_pepper, find_shampoo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shampoo_11_hi);
        mp = new MediaPlayer();
        playTitle();

        find_pepper = (RelativeLayout) findViewById(R.id.find_pepper_layout);
        find_shampoo = (RelativeLayout) findViewById(R.id.find_shampoo_layout);
        ...
        find_shampoo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Perfect!");
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchShampoo11.this);
        ...
        find_pepper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s116_hi);// create's
