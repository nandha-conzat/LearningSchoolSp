 ...
 */
public class MatchSoap5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_5_hi);
        cartoon_spoon = (ImageView)findViewById(R.id.cartoon_soap);
        cartoon = (ImageView)findViewById(R.id.cartoon);
        next = (ImageView)findViewById(R.id.imageNext_pa3_v5);
        back = (ImageView) findViewById(R.id.imageback_pa3_v5);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v5);
        mp = new MediaPlayer();
        playTitle();
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s44);// create's
