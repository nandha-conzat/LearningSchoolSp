 ...
 */
public class MatchPlateFive extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_curtain, drop_door, drop_plate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_five_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_plate_frame);
        drop_curtain = (RelativeLayout) findViewById(R.id.fixed_curtain_layout);
        drop_door = (RelativeLayout) findViewById(R.id.fixed_door_frame);
...
//                        dispaly.setTextColor(Color.GREEN);
                        ...
                        cdd = new CustomDialogClass_hi(MatchPlateFive.this);
        ...
        drop_curtain.setOnDragListener(new View.OnDragListener() {
...
//                        dispaly.setTextColor(Color.RED);
        ...
        drop_door.setOnDragListener(new View.OnDragListener() {
