 ...
 */
public class MatchLock2 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_lock, drop_rose;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_2_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_tary);
        drop_lock = (RelativeLayout) findViewById(R.id.fixed_tray_layout);
        drop_rose = (RelativeLayout) findViewById(R.id.fixed_clock_layout);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchLock2.this);
...
//                        dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s142_hi);// create's
