 ...
 */
public class MatchLock12 extends AppCompatActivity {
    ImageView drag, next, back, home;
    private MediaPlayer mp;
    TextView tuck, slop, lock, dispaly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_lock_12_hi);
        mp = new MediaPlayer();
        playTitle();

        tuck = (TextView) findViewById(R.id.txt_tuck);
        slop = (TextView) findViewById(R.id.txt_slop);
        lock = (TextView) findViewById(R.id.txt_lock);
...
//                dispaly.setTextColor(Color.RED);
        ...
        tuck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchLock12.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s152_hi);// create's
