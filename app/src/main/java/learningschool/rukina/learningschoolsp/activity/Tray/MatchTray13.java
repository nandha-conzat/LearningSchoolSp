 ...
 */
public class MatchTray13 extends AppCompatActivity {
    ImageView next, home, back, pray, trys, tray, gray, ray, stray;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_tray_13_hi);
        mp = new MediaPlayer();
        playTitle();

        pray = (ImageView) findViewById(R.id.pray_image);
        trys = (ImageView) findViewById(R.id.try_image13);
        tray = (ImageView) findViewById(R.id.tray_image13);
        gray = (ImageView) findViewById(R.id.gray_image13);
        ray = (ImageView) findViewById(R.id.ray_image13);
        stray = (ImageView) findViewById(R.id.stray_image13);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchTray13.this);
...
//                dispaly.setTextColor(Color.RED);
        ...
        stray.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.s136_hi);// create's
