 ...
 */
public class MatchShirt2 extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_shirt, drop_frock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_shirt_2_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_shirt);
        drop_shirt = (RelativeLayout) findViewById(R.id.fixed_shirt_layout);
        drop_frock = (RelativeLayout) findViewById(R.id.fixed_frock_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        next = (ImageView) findViewById(R.id.imageNext_pa4_v2);
        back = (ImageView) findViewById(R.id.imageback_pa4_v2);
        home = (ImageView) findViewById(R.id.imagehome_pa4_v2);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchShirt2.this);
...
//
        ...
        drop_frock.setOnDragListener(new View.OnDragListener() {
