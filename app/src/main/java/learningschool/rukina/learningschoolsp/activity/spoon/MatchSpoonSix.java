 ...
 */
public class MatchSpoonSix extends AppCompatActivity {
    ImageView cartoon_spoon,cartoon,next,back, home;
    private MediaPlayer mp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.match_spoon_six_hi);
        cartoon_spoon = (ImageView)findViewById(R.id.cartoon_spoon);
        cartoon = (ImageView)findViewById(R.id.cartoon);
        next = (ImageView)findViewById(R.id.imageNext_pa2_v6);
        back = (ImageView) findViewById(R.id.imageback_pa2_v6);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v6);
        mp = new MediaPlayer();
        playTitle();

        cartoon_spoon.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.spoon_audio_v5);// create's
