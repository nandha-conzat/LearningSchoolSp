 ...
 */
public class MatchPlateOne extends AppCompatActivity {
    ImageView drag, next, back, home;
    RelativeLayout drop_palte, drop_bowl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_plate_one_hi);
        mp = new MediaPlayer();
        playTitle();
            ...
            public boolean onDrag(View v, DragEvent event) {
                ...
                switch (action) {
                    ...
                    case DragEvent.ACTION_DROP: {
                        ...
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchPlateOne.this);
...
//
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_7);// create's
