 ...
 */
public class MatchSpoonTwo extends AppCompatActivity {
    ImageView drag, back, home, next;
    RelativeLayout drop_spoon, drop_bowl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_two_hi);
        mp = new MediaPlayer();
        playTitle();

        drag = (ImageView) findViewById(R.id.drag_spoon);
        drop_spoon = (RelativeLayout) findViewById(R.id.fixed_spoon_layout);
        drop_bowl = (RelativeLayout) findViewById(R.id.fixed_bowl_layout);
        dispaly = (TextView) findViewById(R.id.txt_dispaly);
        back = (ImageView) findViewById(R.id.imageback_spoon_v2);
        home = (ImageView) findViewById(R.id.imagehome_spoon_v2);
        next = (ImageView) findViewById(R.id.imageNext_spoon_v2);
...
//                        dispaly.setTextColor(Color.GREEN);
                        playPerfect();
                        cdd = new CustomDialogClass_hi(MatchSpoonTwo.this);
...
//
        ...
        drop_bowl.setOnDragListener(new View.OnDragListener() {
