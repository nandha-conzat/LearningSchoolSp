 ...
 */
public class MatchSpoonSeventeen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_spoon_seventeen_hi);
        mp = new MediaPlayer();
        playTitle();


        back = (ImageView) findViewById(R.id.imageback_pa2_v17);
        home = (ImageView) findViewById(R.id.imagehome_pa2_v17);
        next = (ImageView) findViewById(R.id.imageNext_pa2_v17);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSpoonSeventeen.this);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s37);// create's
