 ...
 */
public class MatchSoap12 extends AppCompatActivity {
    ImageView next, back, hand, latch, towel, mug, dish, soap, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.match_soap_12_hi);
        mp = new MediaPlayer();
        playTitle();

        soap = (ImageView) findViewById(R.id.soap_image12_fix);
        hand = (ImageView) findViewById(R.id.hand_image12);
        latch = (ImageView) findViewById(R.id.latch_image12);
        towel = (ImageView) findViewById(R.id.towel_image12);
        mug = (ImageView) findViewById(R.id.mug_image12_fixed);
        dish = (ImageView) findViewById(R.id.dish_image12_fix);

        next = (ImageView) findViewById(R.id.imageNext_pa3_v12);
        back = (ImageView) findViewById(R.id.imageback_pa3_v12);
        home = (ImageView) findViewById(R.id.imagehome_pa3_v12);
...
//                dispaly.setTextColor(Color.RED);
        ...
        latch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                dispaly.setText("Wrong!");
//                dispaly.setTextColor(Color.RED);
...
//                dispaly.setTextColor(Color.GREEN);
                playPerfect();
                cdd = new CustomDialogClass_hi(MatchSoap12.this);
...
//                dispaly.setTextColor(Color.RED);
    ...
    public void playTitle() {
        ...
        mp = MediaPlayer.create(getApplicationContext(), R.raw.audio_s51);// create's
